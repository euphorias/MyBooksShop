<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BLCategoryOpenPage.aspx.cs" Inherits="Books.admin.BLCategoryOpenPage" %>
...
<body style="margin:10px">
    ...
    <table class="table table-bordered" style="width:95%">
        <tr>
            <td>大类别名称：</td>
            <td>
               <asp:TextBox ID="txtBlname" runat="server" CssClass="span1" style="width:200px" ></asp:TextBox>
            </td>
        </tr>
    </table>
